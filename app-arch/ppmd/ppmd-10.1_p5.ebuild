...
src_prepare() {
	epatch "${FILESDIR}/${PN}-00_makefile.patch"
	epatch "${FILESDIR}/${PN}-01_upstream.patch"
	epatch "${FILESDIR}/${PN}-02_non-intel.patch"
	epatch "${FILESDIR}/${PN}-03_hardlink.patch"
	epatch "${FILESDIR}/${PN}-04_warnings.patch"
	epatch "${FILESDIR}/${PN}-05_no_copy_dirent.patch"
	epatch "${FILESDIR}/${PN}-06-def-oneproc.patch"
	sed b/Makefile \
